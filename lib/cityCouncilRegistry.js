...
export const CITY_COUNCIL_REGISTRY = {
  nyc: {
    ...
    extraLayers: [
      ...
      { slug: 'nyc-cd',  label: 'Community Districts / Boards' },
      { slug: 'nyc-nda', label: 'Neighborhood Development Areas (DYCD)' },
    ],
  },
  'nyc-nta': {
    name: 'New York City',
  ...
  'nyc-cd': {
    name: 'New York City',
    displayName: 'NYC Community Districts / Boards',
    // Verified 2026-05-28: BetaNYC mirror of DCP Community Districts (clipped to shoreline).
    // BoroCD is a 3-digit code: 1xx=Manhattan, 2xx=Bronx, 3xx=Brooklyn, 4xx=Queens, 5xx=Staten Island.
    // Community Boards and Community Districts are the same boundary (CB n = CD n by city charter).
    arcgisEndpoint: 'https://services2.arcgis.com/IsDCghZ73NgoYoz5/arcgis/rest/services/nycd/FeatureServer',
    layerId: 4,
    districtField: 'BoroCD',
  },
  'nyc-nda': {
    name: 'New York City',
    displayName: 'NYC Neighborhood Development Areas',
    // Verified 2026-05-28: NYC Open Data Socrata dataset published by DYCD (not HPD).
    // Used to administer federal Community Services Block Grant anti-poverty funding.
    // Only 6 NDAs citywide. Socrata returns GeoJSON directly — no ArcGIS-style query syntax.
    source: 'socrata',
    socrataHost: 'data.cityofnewyork.us',
    datasetId: 'vd7c-qjsx',
    districtField: 'nda',
  },
  la: {
