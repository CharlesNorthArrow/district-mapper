...
// Census Tracts (layer /14) and County Subdivisions (layer /8) endpoints need field verification.
// Opportunity Zones endpoint (HUD ArcGIS) needs endpoint and field verification.
// queryMode:
...
// HUD Opportunity Zones ArcGIS service — fields: GEOID10, STATEFP
const HUD_OZ_SVC = 'https://services.arcgis.com/VTyQ9soqVukalItT/arcgis/rest/services/Opportunity_Zones/FeatureServer/0';
...
export const LAYER_CONFIG = {
  ...
  'census-tracts': {
    ...
    endpoint: `${TIGERWMS}/14`,
    queryMode: 'byState',
    paginated: true,              // large states have 5,000–8,000+ tracts
    districtField: 'NAME',
    stateField: 'STATE',
  ...
  'opportunity-zones': {
    ...
    stateField: 'STATEFP',        // HUD uses standard Census STATEFP field
    maxAllowableOffset: 0.001,
